...
class ImagePickerViewController: UIViewController, AVCapturePhotoCaptureDelegate  {
    ...
    var flippedPos = AVCaptureDevicePosition.front
    ...
    override func viewDidLoad() {
        ...
        captureNewSession(devicePostion: flippedPos)
...
//        }
        photoOutput.capturePhoto(with: AVCapturePhotoSettings.init(), delegate: self)
    }
    ...
    @IBAction func flipCamera(_ sender: UIButton) {
        ...
        if let device = captureDevice {
            ...
            flippedPos = AVCaptureDevicePosition.back
            } else {
                flippedPos = AVCaptureDevicePosition.front
            }
            
            for input in captureSession.inputs {
                let castInput = input as! AVCaptureInput
                captureSession.removeInput(castInput)
            }
